...
function Character:new( charType )
	...
	o.shader = love.graphics.newShader( "outline.glsl" )
...
function Character:init()
	images["skeleton"] = love.graphics.newImage("skeleton_3.png")
	images["spearguy"] = love.graphics.newImage("spear_walk_m.png")
